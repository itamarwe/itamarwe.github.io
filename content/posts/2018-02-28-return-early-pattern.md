...
The "return early" pattern also encourages cleaner code by promoting functions that perform a single task. According to the principles of ["clean code" principles](/blog/Clean-code-main-takeaways/),
